...
public class InputMessage {
  ...
  public boolean equals(Object obj) {
    ...
    InputMessage guest = (InputMessage) obj;
    return type.equals(guest.getType()) &&
        playerId.equals(guest.getPlayerId()) &&
        matchId.equals(guest.getMatchId()) &&
        fingerprint.equals(guest.getFingerprint()) &&
        playPosition.equals(guest.getPlayPosition());
  }
}